...
public class Practice12MeasureTextView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float width_text2 = paint2.measureText(text2);
        float width_text1 = paint1.measureText(text1);
        canvas.drawText(text1, 50, 200, paint1);
        canvas.drawText(text2, 50 + width_text1, 200, paint2);
        canvas.drawText(text3, 50 + width_text2 + width_text1, 200, paint1);
    }
}
